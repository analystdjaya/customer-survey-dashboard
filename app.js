...
function renderFrame(){
 ...
 $('#app').innerHTML=`<header class="header"><div class="header-titles"><h1>Customer Satisfaction Survey 2026</h1><div class="subtitle">${esc(scopeTitle)}</div></div><div class="header-actions">${unitFilter}${typeFilter}${customerFilter}<button type="button" class="download" id="download">⇩ &nbsp; Download Raw Data (Excel)</button></div><img class="brand" src="assets/diamond.png" alt="Diamond"></header><main class="body"><div class="watermark" aria-hidden="true">CONFIDENTIAL</div><div id="results"></div></main><footer class="footer"><img class="joy" src="assets/delivering-joy.jpg" alt="delivering joy"><span>Last updated: ${esc(payload.updated)} &nbsp; · &nbsp; Confidential – For Internal Use Only</span></footer>`;
